            ...
            <Card className="card-glow border-2 border-primary/30 bg-card/80 backdrop-blur">
              ...
              <CardContent className="space-y-6 text-lg">
                <p className="leading-relaxed">
                  За более чем 10 лет практики консультаций я разработал уникальные подходы и авторские 
                  методики чтения судьбы по линиям рук. Мой опыт позволяет видеть не только очевидные знаки, 
                  но и тонкие нюансы, которые открывают истинное предназначение человека.
                </p>
                <p className="leading-relaxed">
              ...
              <CardContent className="p-8">
                <div className="space-y-6">
                  <div className="flex items-center justify-center gap-4 text-lg">
                    ...
                    <a href="https://wa.me/79193935188" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                      +7 (919) 393-51-88
                    </a>
                  </div>
                  <div className="flex items-center justify-center gap-4 text-lg">
